...
#
% if node.dns.forward_zones:
forward-zones=${','.join(["%s=%s" % tuple for tuple in node.dns.forward_zones])}
% endif
...
#
query-local-address=${node.loopback}
