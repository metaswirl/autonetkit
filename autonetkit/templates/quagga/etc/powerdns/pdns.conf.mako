<% 
    if not node.dns.role == "server":
        return
%>
# This template is designed for experimental use.
# It forces powerdns to do as little caching as 
# possible and to rely on the power of the back-
# end only.
#
...
#
launch=pipe
pipe-command=${node.dns.pipe_command}
...
#
local-address=127.0.0.1,${node.loopback}  
...
#
query-local-address=0.0.0.0,${node.loopback} 
